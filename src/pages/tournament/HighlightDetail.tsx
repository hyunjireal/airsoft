...
export function HighlightDetail() {
  ...
  if (!highlight) {
    return <div className="page"><h1 className="page-title">하이라이트를 찾을 수 없어요</h1></div>
  }
  ...
  return (
    <div className="page">
      ...
      <section className="section">
        <div className="placeholder-image">영상 영역</div>
      ...
      <Link className="button primary-button" to="/tournament/mvp-vote">MVP 후보로 보기</Link>
    </div>
  )
}
