...
export function TeamMatchDetail() {
  ...
  if (!event) {
    return <div className="page"><h1 className="page-title">팀 매치를 찾을 수 없어요</h1></div>
  }
  ...
  return (
    <div className="page">
      ...
      <section className="section">
        ...
        <article className="card safety-notice-card">
          <h2>🚨 필수 안전 및 규정 안내</h2>
      ...
      <Link className="button primary-button" to={`/match/join/team/${event.id}/apply`}>참가신청</Link>
    </div>
  )
}
